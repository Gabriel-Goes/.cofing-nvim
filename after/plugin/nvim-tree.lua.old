local function my_on_attach(bufnr)
    ...
    -- Function to open the tree explorer
    -- BEGIN_DEFAULT_ON_ATTACH
    vim.keymap.set('n', '<A-]>',   api.tree.change_root_to_node,        opts('CD'))
    vim.keymap.set('n', '<A-i>',   api.node.show_info_popup,            opts('Info'))
    vim.keymap.set('n', '<A-r>',   api.fs.rename_sub,                   opts('Rename: Omit Filename'))
    vim.keymap.set('n', '<A-t>',   api.node.open.tab,                   opts('Open: New Tab'))
    vim.keymap.set('n', '<A-e>',    api.node.open.edit,                  opts('Open'))
